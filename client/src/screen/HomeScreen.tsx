...
const styles = StyleSheet.create({
 ...
 downText: {
  textAlign: 'center',
  fontWeight: '600',
  marginTop: height * 0.58, // replaces '100%' with consistent spacing below
  ...
  getStartedWrapper: {
    ...
    height: height * 0.065, // responsive
  ...
  logo: {
    height: height * 0.17, // responsive
    width: height * 0.17,
    resizeMode: 'contain',
    position: 'absolute',
    top: height * 0.03, // responsive
    right: width * 0.01, // responsive
  },
});
