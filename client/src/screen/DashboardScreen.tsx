  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      >
        ...
        <Text style={[styles.countText, { color: '#0D47A1' }]}>
                ...
                onPress={async () => {
                  try {
                    const response = await fetch(
                      `${BASE_URL}/update-attendance-time`,
                      {
                        method: 'POST',
        ...
        <DateTimePicker
          ...
          onChange={(event, selectedDate) => {
            ...
            if (selectedDate) {
              ...
              const formatted = `${String(((hours + 11) % 12) + 1).padStart(
                2,
                '0',
              )}:${String(minutes).padStart(2, '0')}:00 ${ampm}`;
