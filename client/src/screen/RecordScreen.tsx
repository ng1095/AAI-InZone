...
// const RecordScreen: React.FC<RecordScreenProps> = ({ employeeId: propEmployeeId, fromAdmin }) => {
...
//         if (!fromAdmin) {
//           const resUser = await axios.post("http://192.168.0.111:5001/userdata", { token });
//           empId = resUser.data.data.employeeId;
//         }

//         const [presentRes, absentRes] = await Promise.all([
//           axios.post("http://192.168.0.111:5001/get-attendance-by-status", {
//             employeeId: empId,
//             status: "Present",
//             month: selectedMonth,
//             year: selectedYear,
...
//       const res = await axios.post("http://192.168.0.111:5001/get-attendance-by-status", {
//         employeeId: empId,
//         status,
//         month: selectedMonth,
//         year: selectedYear,
